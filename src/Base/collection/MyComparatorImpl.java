...
//        List<Student> collect1 = Arrays.Base.stream(students).sorted(new MyComparatorImpl()).collect(Collectors.toList());
//        List<Student> collect = Arrays.Base.stream(students).sorted(Comparator.comparing(Student::getScore)).collect(Collectors.toList());
